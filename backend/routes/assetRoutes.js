...
const {createAsset , getAllAssets , getAssetById , assign, returnAsset ,updateAssets, deleteasset , UserAssets , assetStats} = require("../controllers/assetController");
const { verifyToken } = require("../middleware/verifytoken");
const { allowRoles } = require("../middleware/checkrole");

// Routes
router.post("/add", verifyToken, allowRoles("admin", "IT"), createAsset);
router.get("/stats", verifyToken, allowRoles("admin"), assetStats);
